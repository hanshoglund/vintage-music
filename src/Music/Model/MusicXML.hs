...
data TrillStep  = TrillWhole | TrillHalf | TrillUnison
...
Measure width is specified in tenths. These are the global tenths specified in the scaling element, not local tenths as modified by the staff-size element.</xs:documentation>
        </xs:annotation>
...
-}
type ScoreHeader = TODO
type MusicData = TODO
type MeasureAttribute = TODO
{-
...
type ScorePartwise = (ScoreHeader, [[(MusicData, MeasureAttribute)]])
