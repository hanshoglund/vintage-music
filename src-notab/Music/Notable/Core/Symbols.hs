...
-- Rests
symbolSpacer ("Helsinki",         "\xd3")    =  r2 (0.32, 1)
symbolSpacer ("Helsinki",         "\x2211")  =  r2 (0.32, 1)
symbolSpacer ("Helsinki",         "\x152")   =  r2 (0.26, 1)
symbolSpacer ("Helsinki",         "\x2030")  =  r2 (0.34, 1)
symbolSpacer ("Helsinki",         "\x2248")  =  r2 (0.34, 1)
symbolSpacer ("Helsinki",         "\xae")    =  r2 (0.36, 1)
...
-- Accidentals
symbolSpacer ("Helsinki",         "\x222b")  =  r2 (0.34, 0.5)
symbolSpacer ("Helsinki",         "b")       =  r2 (0.2,  0.5)
symbolSpacer ("Helsinki",         "n")       =  r2 (0.2,  0.5)
symbolSpacer ("Helsinki",         "#")       =  r2 (0.26, 0.5)
symbolSpacer ("Helsinki",         "\x2039")  =  r2 (0.26, 0.5)

-- Articulations
symbolSpacer ("Helsinki",         "U")       =  r2 (0.62,  0.5)
symbolSpacer ("Helsinki",         "u")       =  r2 (0.62,  0.5)
symbolSpacer ("Helsinki",         "^")       =  r2 (0.3,   0.5)
symbolSpacer ("Helsinki",         "V")       =  r2 (0.3,   0.5)
symbolSpacer ("Helsinki",         "+")       =  r2 (0.3,   0.5)
symbolSpacer ("Helsinki",         "o")       =  r2 (0.22,  0.5)
symbolSpacer ("Helsinki",         "v")       =  r2 (0.3,   0.5)
symbolSpacer ("Helsinki",         ">")       =  r2 (0.45,   0.5)
symbolSpacer ("Helsinki",         "-")       =  r2 (0.35,  0.5)
symbolSpacer ("Helsinki",         ".")       =  r2 (0.1,   0.5)
...
-- Rests
symbolOffset ("Helsinki",         "\xd3")    =  r2 (0.32 / 2, 0)
symbolOffset ("Helsinki",         "\x2211")  =  r2 (0.32 / 2, 0)
symbolOffset ("Helsinki",         "\x152")   =  r2 (0.26 / 2, 0)
symbolOffset ("Helsinki",         "\x2030")  =  r2 (0.34 / 2, 0)
symbolOffset ("Helsinki",         "\x2248")  =  r2 (0.36 / 2, 0)
symbolOffset ("Helsinki",         "\xae")    =  r2 (0.36 / 2, 0)
...
-- Accidentals
symbolOffset ("Helsinki",         "\x222b")  =  r2 (0.34 / 2, 0)
symbolOffset ("Helsinki",         "b")       =  r2 (0.2 / 2,  0)
symbolOffset ("Helsinki",         "n")       =  r2 (0.2 / 2,  0)
symbolOffset ("Helsinki",         "#")       =  r2 (0.26 / 2, 0)
symbolOffset ("Helsinki",         "\x2039")  =  r2 (0.26 / 2, 0)

-- Articulations
symbolOffset ("Helsinki",         "U")       =  r2 (0.62 / 2, 0)
symbolOffset ("Helsinki",         "u")       =  r2 (0.62 / 2, 0)
symbolOffset ("Helsinki",         "^")       =  r2 (0.3 / 2,  0)
symbolOffset ("Helsinki",         "V")       =  r2 (0.3 / 2,  0)
symbolOffset ("Helsinki",         "+")       =  r2 (0.3 / 2,  0)
symbolOffset ("Helsinki",         "o")       =  r2 (0.22 / 2, 0)
symbolOffset ("Helsinki",         "v")       =  r2 (0.3 / 2,  0)
symbolOffset ("Helsinki",         ">")       =  r2 (0.45 / 2, 0)
symbolOffset ("Helsinki",         "-")       =  r2 (0.35 / 2, 0)
symbolOffset ("Helsinki",         ".")       =  r2 (0.1 / 2,  0)
